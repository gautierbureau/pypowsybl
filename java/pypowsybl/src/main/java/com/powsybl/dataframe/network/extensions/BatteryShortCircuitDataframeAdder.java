 ...
 * @author Claude Code
 */
public class BatteryShortCircuitDataframeAdder extends AbstractSimpleAdder {
    ...
    private static class BatteryShortCircuitSeries {
        ...
        BatteryShortCircuitSeries(UpdatingDataframe dataframe) {
        ...
        void create(Network network, int row) {
            ...
            if (battery == null) {
                throw new PowsyblException("Invalid battery id : could not find " + batteryId);
            }
            var adder = battery.newExtension(BatteryShortCircuitAdder.class);
    ...
    public void addElements(Network network, UpdatingDataframe dataframe) {
        BatteryShortCircuitSeries series = new BatteryShortCircuitSeries(dataframe);
