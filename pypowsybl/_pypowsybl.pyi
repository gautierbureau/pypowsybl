...
def add_mapping_recipe(dynamic_mapping_handle: JavaHandle, mapping_name: str, parameters: Dict[str, str]) -> None: ...
def get_dynamic_mapping_providers() -> List[str]: ...
def add_synchronous_generator_properties(network_handle: JavaHandle, provider_name: str, parameters: Dict[str, str]) -> None: ...
def get_synchronous_generator_properties_providers() -> List[str]: ...
def add_tap_changer_blockings(network_handle: JavaHandle, provider_name: str, parameters: Dict[str, str]) -> None: ...
def get_tap_changer_blockings_providers() -> List[str]: ...
def add_dynamic_mapping_extensions(network_handle: JavaHandle, extension_name: str, provider_name: str, parameters: Dict[str, str]) -> None: ...
def get_dynamic_mapping_extension_names() -> List[str]: ...
def get_dynamic_mapping_extension_providers(extension_name: str) -> List[str]: ...
def add_dynamic_simulation_extensions(network_handle: JavaHandle, system_name: str, parameters: Dict[str, str]) -> None: ...
def get_dynamic_simulation_systems() -> List[str]: ...
def create_timeseries_mapping() -> JavaHandle: ...
def create_event_mapping() -> JavaHandle: ...
def run_dynamic_simulation(dynamic_model: JavaHandle, network: JavaHandle, dynamic_mapping: JavaHandle, event_mapping: Optional[JavaHandle], timeseries_mapping: Optional[JavaHandle], criteria: Optional[JavaHandle], parameters: DynamicSimulationParameters, report_node: Optional[JavaHandle]) -> JavaHandle: ...
def add_mapping_additional_models(dynamic_mapping_handle: JavaHandle, additional_models_df: Dataframe) -> None: ...
def add_all_dynamic_mappings(dynamic_mapping_handle: JavaHandle, category_name: str, dataframes: List[Optional[Dataframe]]) -> None: ...

def update_all_dynamic_mappings(dynamic_mapping_handle: JavaHandle, category_name: str, dataframes: List[Optional[Dataframe]], strict: int) -> None: ...

def get_mapped_models(dynamic_mapping_handle: JavaHandle, network_handle: JavaHandle) -> SeriesArray: ...

def get_mapped_parameters(dynamic_mapping_handle: JavaHandle) -> SeriesArray: ...

def get_parameter_completions(dynamic_mapping_handle: JavaHandle, network_handle: JavaHandle) -> SeriesArray: ...

def update_mapped_parameter(dynamic_mapping_handle: JavaHandle, parameter_set_id: str, parameter_name: str, value: str) -> None: ...

def load_mapped_parameters(dynamic_mapping_handle: JavaHandle, parameters_file: str) -> None: ...
def get_dynamic_mappings_meta_data(category_name: str) -> List[List[SeriesMetadata]]: ...
def create_criteria() -> JavaHandle: ...
def add_criteria(criteria_handle: JavaHandle, dataframes: List[Optional[Dataframe]]) -> None: ...
def get_criteria_meta_data() -> List[List[SeriesMetadata]]: ...
